...
let package = Package(
    ...
    dependencies: [
        ...
        // 1.4.2 保持一致，并且只把 SRTCBroadcastKit 加到 Broadcast Upload Extension
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SMeeting",
            url: "https://repo.open.seastart.cn/repository/vcs-releases/meeting-swift-sdk-1.3.2.zip",
            checksum: "0363b6d2ec85f75f603584a67d2b5614f1c269a54ed4365842403097257e4409"
        ),
