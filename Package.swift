...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/seastart/srtc-swift-sdk.git", exact: "1.1.0"),
    ],
    targets: [
        // 预编译的 SDK 本体。`import SMeeting` 导入的就是它。
        .binaryTarget(
            name: "SMeeting",
            url: "https://repo.open.seastart.cn/repository/vcs-releases/meeting-swift-sdk-1.1.0.zip",
            checksum: "93ea65d051e232feba11c94051effead6c8412a2d8976c5a4ccf36208612dba4"
        ),
