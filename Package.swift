...
let package = Package(
    ...
    dependencies: [
        ...
        // 1.4.7 保持一致，并且只把 SRTCBroadcastKit 加到 Broadcast Upload Extension
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SMeeting",
            url: "https://repo.open.seastart.cn/repository/vcs-releases/meeting-swift-sdk-1.3.10.zip",
            checksum: "374b8b2000444560589250201a7c4d3d65bfc38c15da3fb4ef9a2bc629ffa079"
        ),
